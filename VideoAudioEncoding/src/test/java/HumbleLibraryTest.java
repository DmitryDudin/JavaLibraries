...
public class HumbleLibraryTest {
//    https://github.com/artclarke/humble-video/tree/master/humble-video-demos
    ...
    public static void main(String[] args) throws InterruptedException, IOException {
        ...
        try {
            ...
            if (cmd.hasOption("version")) {
                ...
                formatter.printHelp(HumbleLibraryTest.class.getCanonicalName() + " [<filename> ...]", options);
            } else {
